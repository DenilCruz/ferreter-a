<aside class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
        <!-- Grupo General -->
        <div style="padding: 12px 20px 8px; font-size: 0.75rem; font-weight: 800; color: var(--text-light); text-transform: uppercase; letter-spacing: 0.05em;">
            General
        </div>
        ...
        <div style="margin-top: 10px; padding: 12px 20px 8px; font-size: 0.75rem; font-weight: 800; color: #00AF9A; text-transform: uppercase; letter-spacing: 0.05em; display: flex; align-items: center; gap: 6px; border-top: 1px solid rgba(0,0,0,0.05);">
        ...
        <div style="background: rgba(0, 175, 154, 0.03); border-left: 3px solid #00AF9A;">
        ...
        {{-- Separador y Cerrar Sesión al final del nav --}}
