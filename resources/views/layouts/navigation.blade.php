<nav x-data="{ open: false }" class="bg-white/90 backdrop-blur-md border-b border-slate-200/80 shadow-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-slate-500 hover:text-teal-700 hover:bg-teal-50 focus:outline-none focus:bg-teal-50 transition duration-150 ease-in-out">
